...
它现在也可以把远程 [MyTube](https://github.com/franklioxygen/MyTube) 后端作为只读来源接入，把本地库和远程库合并到同一个 Feed 中，并通过 MikMok 代理远程视频流、缩略图和作者头像。
...
- 支持连接一个或多个远程 MyTube 后端，并把远程视频并入同一个 Feed
...
- [MyTube 连接指南](documents/zh/mytube-connection.md)
